...
### Crea una función (o simplemente define un string arriba) que reciba un string
...
### No se pueden crear funciones externas, no se pueden usar métodos de string además de el .length y tampoco se deben usar metodos de Arrays, unicamente borrar y agregar de ser necesario.
